...
<!-- NEXT_APP_VERSION = v1.1.0
NEXT_PUBLIC_API_KEY = https://gateway-dev.identitygram.co.uk/
NEXT_PUBLIC_ALLOW_API_MOCKING = false
NEXT_PUBLIC_AWS_BASE_URL = https://ig-s3-public-dev-001.s3.eu-west-2.amazonaws.com/
PORT = 3000 -->
